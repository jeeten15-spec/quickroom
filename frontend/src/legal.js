    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Labelled Monetag direct-link units (728×90 at the top, 160×600 at the sides, and 320×50 at the bottom) may appear on public pages and to the right of a chat window. They open in a new tab and do not wrap Create room, Join, or public-room buttons. We do not load Monetag vignette, in-page push, OnClick, or pop-under tags, because those overlay the page or intercept clicks.',
