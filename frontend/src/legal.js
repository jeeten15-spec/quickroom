  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Display ads sit in reserved IAB frames (728×90, 160×600, 300×250, 320×50) on public pages. When Google AdSense is configured, those frames serve impression-based display ads and do not wrap Create, Join, or room buttons. Chat only uses a right-hand 160×600 frame so the composer stays clear.',
