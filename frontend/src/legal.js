  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Adsterra still fills some IAB frames on public pages except About: a 728×90 along the top and bottom on wide screens, a 300×250 on small screens, and at most one 160×600 rail on blog, privacy, and long articles (Home still uses more rails). Live chat keeps a single right-hand 160×600 on wide screens. Create and the operator dashboard have no ads.',
          'On blog posts, use-case pages, and the privacy pages we also use higher-yield formats than stacked banners: one Native 1:1 unit in the article body, a labeled sponsored text offer, and a desktop sticky 728×90 anchor (better viewability than extra skyscrapers). We do not use Monetag OnClick, pop-under, or other forced-click formats.',
