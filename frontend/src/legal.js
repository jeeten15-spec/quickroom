  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Display ads sit in reserved IAB frames (728×90, 160×600, 300×250, 320×50) on public pages such as Home, About, Blog, use cases, and guides. Google AdSense (publisher ca-pub-2208705874716134) fills those frames. Create, Join, the operator dashboard, and live chat rooms do not show AdSense units, so room buttons and the conversation stay clear.',
          'Monetag in-page push and vignette cannot be locked to those frames (they overlay the page). We load them only on long articles, guides, and use-case pages, after a delay (about 3 seconds for in-page push, 10 seconds for vignette, vignette at most once per browser session). They are not loaded on the homepage Create/Join flow or inside a room. We do not use Monetag OnClick or pop-under tags.',
