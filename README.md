...
3. **Ads.** Homepage left/right 160×600 rails are Monetag **direct links** only (`omg10.com/4/11680015`), opening in a new tab. Do not use vignette, in-page push, OnClick, or pop-under — those overlay the UI and intercept Create/Join/room clicks. `/sw.js` may still be hosted. Set `VITE_ADSENSE_CLIENT` after AdSense approval.
